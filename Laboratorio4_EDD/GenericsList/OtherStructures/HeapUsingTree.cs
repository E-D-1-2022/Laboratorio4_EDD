...
using GenericsList.TreeStructures;
using GenericsList.LinearStructures;
namespace GenericsList.OtherStructures
{
    public class HeapUsingTree<K, V> : IHeap<K, V>
    {
        ...
        public CustomStack<TreeNode<K, V>> nodesStack;
